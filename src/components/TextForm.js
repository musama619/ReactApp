  ...
  return (
    <>
      <div>
        ...
        <span className="btn-label"><i className={`fa fa-chevron-${btntext === 'Convert to Uppercase' ? 'up' : 'down'} mx-1`}></i></span>
          {btntext}
        </button>
        <button className="btn btn-success mx-1 text-white" onClick={speakText}>
        <span className="btn-label"><i className="fa fa-volume-up mx-1"></i></span>
          Read Text
        </button>
        
        <button className="btn btn-secondary mx-1" onClick={removeText}>
        <span className="btn-label"><i className="fa fa-trash mx-1"></i></span>
          Remove Text
        </button>

        <button className="btn btn-labeled btn-danger mx-1" onClick={undoText}>
        <span className="btn-label"><i className="fa fa-undo mx-1"></i></span>
          Undo
        </button>
      </div>
